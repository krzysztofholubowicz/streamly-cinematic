    ...
    <section className="py-24 border-y border-border">
      <div className="container mx-auto px-6 lg:px-12">
        <motion.p
          ...
          className="text-center text-muted-foreground mb-16 max-w-2xl mx-auto text-lg leading-relaxed"
        >
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
          ...
          <motion.div
            ...
            className="border border-dashed border-border rounded-2xl p-8 text-center opacity-25 flex flex-col items-center justify-center"
          >
