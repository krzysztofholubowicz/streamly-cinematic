...
export const equipmentCategories: EquipmentCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'dedolight-sps5', name: 'Dedolight SPS5 Portable Studio', quantity: 1, category: 'lighting', image: '/equipment/dedolight-sps5.jpg', note: 'Zestaw 5 lamp z softboxami i akcesoriami w walizce transportowej' },
    ],
  },
  {
    id: 'audio',
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'vinten-vision-blue', name: 'Vinten Vision Blue5', quantity: 1, category: 'tripods', image: '/equipment/vinten-vision-blue.jpg' },
    ],
  },
];
