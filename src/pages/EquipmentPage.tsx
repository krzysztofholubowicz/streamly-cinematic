        ...
        <section className="section-padding">
          <div className="max-w-5xl">
            ...
            >
              ...
              <br />
              <span className="text-muted-foreground">broadcastowy</span>
            </motion.h1>
            ...
            >
              Kamery, obiektywy, światło, dźwięk, streaming – wszystko, 
              czego potrzebujesz do profesjonalnej realizacji w jednym miejscu.
            </motion.p>
          </div>
        </section>
          ...
          <div className="flex flex-wrap gap-4">
            {equipmentCategories.map((cat) => (
              <button
                ...
                className={`px-6 py-3 text-sm uppercase tracking-[0.15em] border transition-all duration-300 ${
          ...
          <div className="grid lg:grid-cols-2 gap-16">
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed mb-8">
                Wypełnij formularz, a odpowiemy w ciągu 2 godzin w dni robocze. 
                Ceny dostępne po wysłaniu zapytania.
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-transparent border border-border px-4 py-3 text-foreground focus:border-foreground outline-none transition-colors resize-none"
                  placeholder="Np. Sony FX9, Aputure 600D..."
                />
              </div>
